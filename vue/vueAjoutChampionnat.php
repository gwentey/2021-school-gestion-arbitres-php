...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Ajout d'un championnat</h1>
    </div>
    <div class="alert alert-warning" role="alert">Pour ajouter un championnat veuillez simplement compléter les champs ci-dessous !</div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <input name="nom_championnat" value="" type="text" class="form-control" placeholder="Choisissez un nom pour le chamionnat">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="num_division" class="form-control">
                                    ...
                                    <option value="<?php echo $leResultat->num_division; ?>">
                                        <?php echo $leResultat->nom_division; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <select name="num_type_championnat" class="form-control">
                                    ...
                                    <option value="<?php echo $leResultat->num_type_championnat; ?>">
                                        <?php echo $leResultat->nom_type_championnat; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
